...
export class AddProposalActionImagesConstraint1685201083917 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "image" DROP CONSTRAINT "REL_e2a8d2eb051eb21b6715f6d21b"`);
