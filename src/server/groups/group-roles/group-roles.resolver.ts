...
export class GroupRolesResolver {
  ...
  @ResolveField(() => Group)
  async group(@Context() { loaders }: { loaders: Dataloaders }, @Parent() { groupId }: GroupRole) {
  ...
  @ResolveField(() => Int)
  async memberCount(@Parent() { id }: GroupRole, @Context() { loaders }: { loaders: Dataloaders }) {
  ...
  async createGroupRole(@Args('groupRoleData') groupRoleData: CreateGroupRoleInput) {
    return this.groupRolesService.createGroupRole(groupRoleData);
  }

  @Mutation(() => UpdateGroupRolePayload)
  async updateGroupRole(@Args('groupRoleData') groupRoleData: UpdateGroupRoleInput) {
